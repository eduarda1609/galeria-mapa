...
1. Adicionar (Cadastro): Nesta tela você faz o registro de novas imagens.
...
GPS Automático: No momento em que a foto é escolhida, o app captura sua Latitude e Longitude ocultamente e salva tudo no banco local;

2. Galeria: Nesta tela você gerencia tudo o que já foi salvo.
Listagem: Mostra a miniatura da foto, título, data do registro e as coordenadas;
Filtros e Busca: Use a barra superior para pesquisar fotos pelo nome ou digite uma data específica para filtrar. Use o botão "Limpar" para voltar ao normal;
Editar: Permite renomear o título da foto salva;
Excluir: Apaga a foto do banco de dados permanentemente;

3. Mapa: Nesta tela você visualiza as localizações das imagens registradas.
Marcadores (Pinos): Cada foto cadastrada gera um pino laranja no mapa correspondente ao local exato onde foi salva.
Cartão de Detalhes: Ao tocar em um pino, um cartão flutuante aparecerá na parte inferior da tela exibindo a foto em tamanho maior, o título e a data.
